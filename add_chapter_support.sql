...
ALTER TABLE podcast_chunks ADD COLUMN IF NOT EXISTS guest_name VARCHAR(255);
...
COMMENT ON COLUMN podcast_chunks.guest_name IS 'LLM-extracted guest name from transcript';